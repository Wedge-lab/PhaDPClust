...
option_list = list(
  ...
  make_option(c("--clu", "--num_clus_sampler"), type="integer", default=10, help="number of clusters in sampler", metavar="character"),
  ...
  make_option(c("--kill_clu_frac"), type="double", default=0.01, help="The threshold for dropping clusters in phasing version", metavar="character")
)
